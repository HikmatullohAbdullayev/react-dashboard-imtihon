    ...
    <>
      ...
      <header className=" hidden table945:block w-screen bg-#F5F5F5  ">
        <div className="flex justify-between w-full z-0   items-center container px-20 mx-auto max-w-[1169px] my-20 ">
          ...
          <div
            className={` py-20   bg-white table945:flex flex-col  z-10 justify-between items-center gap-20 w-full   table945:absolute top-0 left-0  ${
              openMenu ? "table945:mt-[-900px]" : "table945:mt-0"
            } table945:transition-all duration-500 ease-in-out `}
          >
            <button
              onClick={handeMenu}
              className=" absolute right-0   p-20 m-20 bg-red-600 rounded-8 text-white "
            >
              X
            </button>
            <Nav />
          ...
          <button onClick={handeMenu} className="">
            Open
          </button>
        </div>
      </header>
